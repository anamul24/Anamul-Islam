...
const DEFAULT = {
  tagline: 'The Journey',
  heading: 'About My',
  headingHighlight: 'Self',
  bio: 'As a Computer Science and Engineering student, I am deeply passionate about Network Engineering and the architecture of resilient IT Infrastructure.',
  stats: [
    { value: 'CCNA', label: 'In Progress' },
    { value: 'MikroTik', label: 'Training' },
    { value: '50+', label: 'Lab Hours' },
    { value: 'MERN', label: 'Web Dev' },
  ],
};
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            >
              {data.heading} <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-amber-200 to-white/10">{data.headingHighlight} </span>
            </motion.h2>
            ...
            <motion.div
              ...
              className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mt-8 md:mt-16 w-full"
            >
              {data.stats.map((stat) => (
                <motion.div
                  key={stat.label}
