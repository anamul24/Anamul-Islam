          ...
          >
            ...
            >
              <button
                ...
                className="absolute top-4 right-4 z-20 w-10 h-10 rounded-sm bg-black border border-white/10 flex items-center justify-center text-white hover:bg-emerald-500 hover:text-black transition-all"
              >
              ...
              <div className="md:w-3/5 p-6 md:p-10 overflow-y-auto flex-1">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-3 py-3 min-h-[44px] rounded-sm bg-white/5 border border-white/10 text-white font-mono text-xs uppercase tracking-widest hover:bg-white/10 transition-all"
                  >
                  ...
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-3 py-3 min-h-[44px] rounded-sm bg-emerald-500 text-black font-mono text-xs font-black uppercase tracking-widest hover:bg-emerald-400 transition-all group"
                  >
                    <span>Live Demo</span>
                    <ExternalLink size={16} aria-hidden="true" className="group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                  </a>
                </div>
              </div>
            </motion.div>
